 ...
 * @author timheng
 */
public class JavaFXApplication11_Sep_23_1632 extends Application {
...
//        Group root = new Group();
        ...
        containerLayout.getChildren().addAll(group1,group2);
...
//        root.getChildren().add(group2);
        ...
        Scene scene = new Scene(containerLayout, 1000, 500, Color.WHITE);
